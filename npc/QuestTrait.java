package me.futurize.quests.npc;
...
@TraitName("saved-quest") // convenience annotation in recent CitizensAPI versions for specifying trait
							// name
public class QuestTrait extends Trait {

	QuestsPlugin plugin = null;
	...
	public QuestTrait() {
		super("saved-quest");
		plugin = QuestsPlugin.getInstance();
	}
	...
	public void load(DataKey key) {
		SomeSetting = key.getBoolean("QuestSetting", false);
	}

	// Save settings for this NPC (optional). These values will be persisted to the
	// Citizens saves file
	public void save(DataKey key) {
		key.setBoolean("QuestSetting", SomeSetting);
	}
	...
	public void onAttach() {
		plugin.getServer().getLogger().info(npc.getName() + "has been assigned the Saved-Quest trait!");
	}
	...
	public void onDespawn() {
		plugin.getServer().getLogger().info(npc.getName() + "has despawned!");
	}
	...
	@Override
	public void onSpawn() {
		plugin.getServer().getLogger().info(npc.getName() + "has spawned!");
	}

	// run code when the NPC is removed. Use this to tear down any repeating tasks.
	@Override
	public void onRemove() {
		plugin.getServer().getLogger().info(npc.getName() + "has been removed!");
	}
}
